    ...
    methods:{
            ...
            swal.fire({
                ...
                if (result.value) {
                    axios.delete('/delete/user/'+user.id).then(() =>{
                        ...
                        toast.fire({
                            icon: 'error',
                            title: user.name +" was unable to be removed! Kindly try again later"
                        })
                    })
                }
            })
        ...
        getUsers(){
            ...
            axios.get('/getAllUsers').then((response) =>{
                ...
                this.loading = false;
                this.$toastr.e("Sorry! Unable to load users", "Error");
            })
        },
        viewUser(user){
            $('#viewUser').modal('show');
        ...
        createUser(){
            ...
            this.form.post("/account/create").then((response) => {
                this.load = true;
                this.$toastr.s("A new user has been create succefully!", "Created");
                Fire.$emit("loadUser");
                $("#createUser").modal("hide");
                this.form.reset();
            }).catch(() => {
                this.load = true;
                this.$toastr.e("Sorry! Cannot create a user, try later!", "Error");
            });
        },
        updateUser(){
            ...
            this.form.put("/account/update/" +this.form.id).then((response) => {
                ...
                this.load = true;
                this.$toastr.e("Unable to update user information! Kindly try again", "Error");
            });
        },
    },
    created(){
