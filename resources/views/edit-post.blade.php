                                ...
                                <form method="post" action="{{ route('post.updated') }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" name="onboarding_date" class="form-control" value="{{ $employee->onboarding_date }}"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>
                                                <strong>Supervisor</strong>
                                            </label>
                                            <input type="text" name="supervisor" class="form-control" placeholder="Supervisor" value="{{ $employee->supervisor }}"/>
                                        </div>
                                    </div>
                                    <br>
